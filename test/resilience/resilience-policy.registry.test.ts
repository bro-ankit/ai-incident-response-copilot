...
describe('ResiliencePolicyRegistry Unit Test', () => {
  ...
  describe('Given getOrCreate', () => {
    describe('When no policy exists for the given name', () => {
    ...
    describe('When a policy already exists for the given name', () => {
    ...
    describe('When different names are passed', () => {
  ...
  describe('Given circuit breaker state', () => {
    ...
    describe('When the circuit is open and halfOpenAfter elapses', () => {
      test('Then it allows a probe call, closes on success, and stays closed for the next call', async () => {
        ...
        const probeResult = await policy.execute(op);
