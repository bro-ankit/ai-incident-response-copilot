...
import type { IncidentInsert, IncidentSelect } from '../../src/schema/incidents.schema';
...
export const mockIncidentInsert = (overrides: Partial<IncidentInsert> = {}): IncidentInsert => ({
  title: 'payments-api returning 500s after deploy',
  description: 'Error rate spiked to 40% on payments-api shortly after the 14:02 UTC deploy.',
  service: 'payments-api',
  severity: 'SEV2',
